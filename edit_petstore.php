<?php
	...
	$result = get_petstore($_POST['pst_id']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			<h1>Project 2</h1>
			<h2>Edit Pet Store</h2>
		</div>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<form id="add_store_form" method="post" class="form-horizontal" action="edit_petstore_process.php">
					<div class="form-group">
						<label class="col-sm-3 control-label">Name:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="name" maxlength="30" value="<?php echo(htmlspecialchars($result['pst_name']));?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">Street:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="street" maxlength="30" value="<?php echo(htmlspecialchars($result['pst_street']));?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">City:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="city" maxlength="30" value="<?php echo(htmlspecialchars($result['pst_city']));?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">State:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="state" maxlength="2" value="<?php echo(htmlspecialchars($result['pst_state']));?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">Zip:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="zip" maxlength="9" value="<?php echo(htmlspecialchars($result['pst_zip']));?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">Phone:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="phone" maxlength="10" value="<?php echo(htmlspecialchars($result['pst_phone']));?>" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">Email:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="email" maxlength="100" value="<?php echo(htmlspecialchars($result['pst_email']));?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">URL:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="url" maxlength="100" value="<?php echo(htmlspecialchars($result['pst_url']));?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">Sales:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="sales" maxlength="11" value="<?php echo(htmlspecialchars($result['pst_ytd_sales']));?>"/>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label">Note:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="note" maxlength="250" value="<?php echo(htmlspecialchars($result['pst_note']));?>"/>
						</div>
					</div>
					<input type="hidden" name="id" value="<?php echo $_POST['pst_id']; ?>">
					<div class="form-group">
